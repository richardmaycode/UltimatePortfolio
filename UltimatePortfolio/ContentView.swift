...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .searchable(text: $dataController.filterText, tokens: $dataController.filterTokens, suggestedTokens: .constant(dataController.suggestedFilterTolkens),  prompt: "Filter issues") { tag in
            Text(tag.tagName)
        }
        .toolbar {
            Menu {
