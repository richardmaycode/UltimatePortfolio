...
/// An environment singleton responsible for managing our Core Date stack, including handing saving,
...
class DataController: ObservableObject {
    ...
    /// Inializes a data controller, either in memory (for testing use sach as previewing),
    /// or on permanent storage ( for use in regualr app runs.) Defaults to permanent storage.
    ...
    /// Saves our Core Data context iff there are chagnes. This silently ignores
    ...
    func newIssue() {
        ...
        // add this new issue to that tag otherwise it won't appear in
        // in the list of issues they see.
